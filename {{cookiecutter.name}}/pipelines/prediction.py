...
import kfp.components as comp
import kfp.dsl as dsl
from helper import read_settings
from utils.op_transformers import premp_transformer, gcp_secret_transformer
...
PROJECT_ID = os.getenv('PROJECT_ID', 'mlops-featurestore-sandbox')
KFP_HOST = os.getenv('ENDPOINT', 'https://5265e61e65696eaf-dot-europe-west1.pipelines.googleusercontent.com')
SETTINGS_FILENAME = 'training_settings.yaml'
settings = read_settings(SETTINGS_FILENAME)

BASE_IMAGE = "gcr.io/mlops-featurestore-sandbox/pred:latest"
...
def batch_prediction_pipeline_vtx(
...
if __name__ == '__main__':
    ...
    client.create_run_from_pipeline_func(train_and_evaluate_vtx, arguments={}, mode=kfp.dsl.PipelineExecutionMode.V2_COMPATIBLE)
    """

    output_file = "pipe_predict.json"
    pipeline_root = "gs://gme-e2e-mlops-featurestore-sandbox/"


    compiler.Compiler().compile(
                pipeline_func=batch_prediction_pipeline_vtx,
